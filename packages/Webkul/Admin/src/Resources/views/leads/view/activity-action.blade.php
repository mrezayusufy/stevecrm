                    ...
                    <tab name="{{ __('admin::app.leads.activity') }}">
                        <form action="{{ route('admin.activities.store') }}" method="post" data-vv-scope="activity-form"
                            ...
                            <div class="form-group" :class="[errors.has('activity-form.title') ? 'has-error' : '']">
                                ...
                                <input name="title" class="control" v-validate="'required'"
                            ...
                            <div class="form-group" :class="[errors.has('activity-form.type') ? 'has-error' : '']">
                                ...
                                <select name="type" class="control" v-validate="'required'"
                            ...
                            <div class="form-group date"
                                ...
                                <div class="input-group">
                                    <datetime>
                                        <input type="text" name="schedule_from" class="control" v-model="schedule_from"
                                    ...
                                    <datetime>
                                        <input type="text" name="schedule_to" class="control" v-model="schedule_to" ref="schedule_to"
                            ...
                            <div class="form-group">
                                ...
                                <div class="lookup-control">
                                    <div class="form-group" style="margin-bottom: 0">
                                        <input type="text" class="control" v-model="search_term" autocomplete="off"
                    ...
                    <tab name="{{ __('admin::app.leads.message') }}">
                        <form action="{{ route('admin.message.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="message" class="control" id="message" v-validate="'required'"
